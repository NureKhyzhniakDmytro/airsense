        ...
        <template #content>
          <form class="auth-form" @submit.prevent="handleRegister">
            ...
            <div class="auth-field">
              ...
              />
              <small v-if="passwordTooShort" class="auth-error">Password must be at least 6 characters.</small>
            </div>
            ...
            <div class="auth-field">
              ...
              />
              <small v-if="passwordMismatch" class="auth-error">Passwords do not match.</small>
            </div>
...
const canSubmit = computed(() => (
  Boolean(name.value && email.value && password.value && confirmPassword.value && termsAccepted.value)
